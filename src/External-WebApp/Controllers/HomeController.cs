...
using BenjaminAbt.Samples.AspNetCore_IdentityServer.External_WebApp.ViewModels;
...
using BenjaminAbt.Samples.AspNetCore_IdentityServer.PortalWebApp.Controllers;

namespace BenjaminAbt.Samples.AspNetCore_IdentityServer.External_WebApp.Controllers
{
